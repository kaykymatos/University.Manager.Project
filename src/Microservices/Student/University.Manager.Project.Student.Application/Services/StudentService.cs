...
namespace University.Manager.Project.Student.Application.Services
{
    public class StudentService : IStudentService
    {
        ...
        public StudentService(IStudentRepository studentRepository, ISecurityService securityService, IMapper mapper)
        {
        ...
        public async Task CreateModelAsync(StudentEntityRequestDTO entity)
        {
            ...
            model.Passowrd = _securityService.EncryptPassword(model.Passowrd);
