...
using University.Manager.Project.IdentityServer.Pages.Consent;

namespace University.Manager.Project.IdentityServer.Pages.Device;
...
public class Index : PageModel
{
    ...
    {
        DeviceFlowAuthorizationRequest? request = await _interaction.GetAuthorizationContextAsync(Input.UserCode ?? throw new ArgumentNullException(nameof(Input.UserCode)));
