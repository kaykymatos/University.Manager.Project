...
namespace University.Manager.Project.IdentityServer.Pages.Ciba;
...
public class Consent : PageModel
{
    ...
    public async Task<IActionResult> OnPost()
    {
        ...
        BackchannelUserLoginRequest? request = await _interaction.GetLoginRequestByInternalIdAsync(Input.Id ?? throw new ArgumentNullException(nameof(Input.Id)));
