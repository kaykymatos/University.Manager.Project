...
namespace University.Manager.Project.IdentityServer.Pages.Account.Register
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
               ...
               Config.Employer).GetAwaiter().GetResult();
                    IdentityResult adminClaims = _userManager.AddClaimsAsync(user,
                    [
                        ...
                        new (JwtClaimTypes.Role, Config.Employer)
                    ]).Result;
